...
function ImageResult({ image, isTransforming }: ImageResultProps) {
  ...
  return (
    <div className="flex flex-col gap-4 ">
      ...
      {!image?.url && isTransforming && (
        <div className="relative w-full h-full">
          <div className="flex-center  absolute left-[50%] top-[50%] size-full -translate-x-1/2 -translate-y-1/2 flex-col gap-2 rounded-[10px] border bg-gray-700/90">
            <Image
