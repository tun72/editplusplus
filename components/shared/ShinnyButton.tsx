...
function ShinyButton({
    ...
    return (
        <Link
            ...
            border-white bg-yellow-500 px-8  text-base/7 font-bold text-white transition-all duration-300 hover:ring-2
             hover:ring-yellow-600 hover:ring-offset-2 focus:outline-none focus:ring-2 focus:ring-offset-2`,
                className
            )}
            {...props}
        >
